...
const MathToken = ({ token }) => {
    switch (token.type) {
        case 'superscript':
            return React.createElement("sup", { className: "text-xs" }, token.value);
        case 'subscript':
            return React.createElement("sub", { className: "text-xs" }, token.value);
        case 'fraction':
            const [numerator, denominator] = token.value.split('|');
            return (React.createElement("span", { className: "inline-flex flex-col items-center justify-center mx-1" },
                React.createElement("span", { className: "text-center" }, numerator),
                React.createElement("span", { className: "border-t border-black w-full my-1" }),
                React.createElement("span", { className: "text-center" }, denominator)));
        case 'sqrt':
            return (React.createElement("span", { className: "inline-flex items-baseline" },
                React.createElement("span", { className: "text-2xl" }, "\u221A"),
                React.createElement("span", { className: "border-t border-black pt-1 ml-1 translate-y-2" },
                    React.createElement("span", { className: "-translate-y-12" }, token.value))));
        case 'operator':
            return React.createElement("span", { className: "mx-2" }, token.value);
        case 'derivative':
            return (React.createElement("span", { className: "inline-flex items-baseline" },
        ...
        case 'integral':
            ...
            return (React.createElement("span", { className: "inline-flex items-center mx-2 relative" },
                React.createElement("span", { className: "text-3xl mr-1" }, "\u222B"),
                React.createElement("span", { className: "flex flex-col items-center text-xs absolute", style: { left: '0.5em', height: '100%' } },
                    React.createElement("sup", { className: "transform translate-y-1 translate-x-2" }, upperBound),
                    React.createElement("sub", { className: "transform translate-y-8 translate-x-2" }, lowerBound)),
                React.createElement("span", { className: "ml-3" }, integrand),
                React.createElement("span", { className: "ml-1" },
                    "d",
                    variable)));
        case 'sum':
            const [sumLower, sumUpper, summand] = token.value.split('|');
            return (React.createElement("span", { className: "inline-flex items-center mx-2" },
                React.createElement("span", { className: "text-3xl mr-1" }, "\u03A3"),
                React.createElement("span", { className: "flex flex-col items-center text-xs" },
                    React.createElement("sup", { className: "-mt-1 -translate-y-1" }, sumUpper),
                    React.createElement("sub", { className: "mt-1 translate-y-3" }, sumLower)),
                React.createElement("span", { className: "ml-1" }, tokenize(summand).map((subToken, index) => (React.createElement(MathToken, { key: index, token: subToken }))))));
        case 'limit':
            const [limVariable, approach] = token.value.split('|');
            return (React.createElement("span", { className: "inline-flex items-baseline mx-2" },
                React.createElement("span", { className: "mr-1" }, "lim"),
                React.createElement("sub", { className: "text-xs" },
                    limVariable,
                    "\u2192",
                    approach)));
        default:
            return React.createElement("span", null, token.value);
    }
};
const DefaultIcons = {
    NOTE: (React.createElement("svg", { width: "24", height: "24", fill: "currentColor", viewBox: "0 0 24 24", className: "mr-2" },
        React.createElement("path", { d: "M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z" }))),
    TIP: (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24", height: "24", fill: "currentColor", className: "mr-2" },
        React.createElement("path", { d: "M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z" }))),
    IMPORTANT: (React.createElement("svg", { width: "24", height: "24", fill: "currentColor", viewBox: "0 0 24 24", className: "mr-2" },
        React.createElement("path", { d: "M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" }))),
    WARNING: (React.createElement("svg", { fill: "currentColor", width: "24", height: "24", viewBox: "0 0 24 24" },
        React.createElement("g", null,
            React.createElement("path", { d: "M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" })))),
    CAUTION: (React.createElement("svg", { width: "24", height: "24", fill: "currentColor", viewBox: "0 0 24 24", className: "mr-2" },
        React.createElement("path", { d: "M4.47.22A.749.749 0 0 1 5 0h6c.199 0 .389.079.53.22l4.25 4.25c.141.14.22.331.22.53v6a.749.749 0 0 1-.22.53l-4.25 4.25A.749.749 0 0 1 11 16H5a.749.749 0 0 1-.53-.22L.22 11.53A.749.749 0 0 1 0 11V5c0-.199.079-.389.22-.53Zm.84 1.28L1.5 5.31v5.38l3.81 3.81h5.38l3.81-3.81V5.31L10.69 1.5ZM8 4a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 4Zm0 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z" })))
};
...
function SimpleMarkdown({ content, className = 'dark:prose-invert', ctexTclass = "my-2", imageHeight = 400, theme = 'light', codeBlockTheme = "bg-[#fdf6e3] dark:bg-[#2d353b]", tableHeaderClass = "bg-gray-200 dark:bg-gray-700", tableCellClass = "border px-4 py-2", extraAlerts = [] }) {
    ...
    const parseMarkdown = (md) => {
        ...
        const flushBlockQuote = () => {
            if (inBlockQuote) {
                const alertClass = alertTypes[blockQuoteType] || alertTypes.DEFAULT;
                ...
                for (const type in icons) {
                    let text = alertTextTitles[blockQuoteType] || blockQuoteType.toLowerCase().replace(/^\w/, c => c.toUpperCase());
                    html = html.replace(`[!${type.toUpperCase()}]`, `<div class="flex items ${alertTextColors[blockQuoteType]}
                -center">${renderToString(icons[type]) + text} </div>`);
                }
                //add  line separator
                inBlockQuote = false;
                blockQuoteContent = '';
        ...
        lines.forEach((line, index) => {
            if (line.trim().startsWith('```')) {
                ...
                let mathelements = tokens.map((token, index) => ((React.createElement(MathToken, { key: index, token: token }))));
